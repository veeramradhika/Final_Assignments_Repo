...
namespace UniversityMVCWebApp.Migrations
{
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StatusViewModel", x => x.Email);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StatusViewModel_Email",
                table: "StatusViewModel",
                column: "Email",
                unique: true);
        }
